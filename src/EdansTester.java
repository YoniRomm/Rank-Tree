...
//			int temp = e[i];
//			if (t1.find(temp).getHeight() != 1) {
//				System.out.println("Hight problem in height 1 nodes: height of" + temp + "is" + t1.find(temp).getHeight());
//			}
//		}
//		int[] f = {3,23,99};
...
//			}
//		}
//		if (t1.find(8).getHeight() != 3 || t1.find(77).getHeight() != 3 ) {
//			System.out.println("Hight problem in height 3 nodes");
//		}
//		if (t1.find(33).getHeight() != 4) {
//			System.out.println("Hight problem in height 4 nodes");
//		}
//		if( t1.getRoot().getKey() != 33) {
...
//		t1.insert(102, true);
//		t1.insert(103, false);
//		if (t1.find(101).getParent() != t1.find(77)) {
...
//		}
//		if (t1.successor(t1.find(26)).getKey() != 44 || t1.successor(t1.find(55)).getKey() != 66 || t1.successor(t1.find(100)).getKey() != 101) {
